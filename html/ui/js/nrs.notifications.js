...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.updateNotificationUI = function() {
		...
		if (totalCount > 0) {
			$menuItem.find('span .nm_inner_subtype').css('backgroundColor', '#ed505a');
			...
			var $markReadLink= $("<a href='#' style='color:#24ce94;'>" + $.t('notifications_mark_as_read', 'Mark all as read') + "</a>");
			...
			$menuItem.find('span').css('display','none');
			$menuItem.find('span .nm_inner_subtype').css('display', 'none');
			$menuItem.find('span .nm_inner_total').css('display', 'none');
			var html = "";
