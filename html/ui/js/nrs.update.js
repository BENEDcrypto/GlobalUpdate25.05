/******************************************************************************
 * Copyright © 2020-2021    The NXT Developers.                             *
 *                                                                            *
...
var NRS = (function(NRS, $) {
	...
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "bened-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "bened-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "bened-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "bened-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "bened-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "bened-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "bened-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "bened-client-", ext: "sh"}
	];
...
///// ne chekat
	...
	function checkForNewVersion() {
            ...
            if (NRS.nrsVersion && NRS.nrsVersion.versionNr && NRS.nrsBetaVersion && NRS.nrsBetaVersion.versionNr){
