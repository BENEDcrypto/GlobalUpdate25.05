...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount BENED",
			labelI18n: "amount_cointech",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumBENED",
			addonText: "BENED",
			addonI18n: "cointech_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_cointech', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceBENED';
		context['addonText'] = 'BENED';
		context['addonI18n'] = 'cointech_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_cointech', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
