...
var NRS = (function(NRS, $) {
    ...
    $("#add_monitored_account_modal").on("show.bs.modal", function() {
        ...
        $("#add_monitored_account_amount").val(NRS.convertToBENED(currentMonitor.amount));
        $("#add_monitored_account_threshold").val(NRS.convertToBENED(currentMonitor.threshold));
