...
public class DesktopMode implements RuntimeMode {
    ...
    public void launchDesktopApplication() {
        ...
        try {
            desktopApplication = Class.forName("beneddesktop.DesktopApplication");
            desktopApplication.getMethod("launch").invoke(null);
        } catch (ReflectiveOperationException e) {
            Logger.logInfoMessage("beneddesktop.DesktopApplication failed to launch", e);
        }
    }
    ...
    public void shutdown() {
        ...
        try {
            ...
            Logger.logInfoMessage("beneddesktop.DesktopApplication failed to shutdown", e);
        }
    }
