    ...
    JSONStreamAware processRequest(JSONObject request, Peer peer) {
        ...
        try {
            ...
            if (lastBlockIdString != null) {
                ...
                long myLastBlockId = Bened.getBlockchain().getLastBlock().getId();
                if (myLastBlockId == lastBlockId || Bened.getBlockchain().hasBlock(lastBlockId)) {
            ...
            if (lastMilestoneBlockIdString != null) {
                Block lastMilestoneBlock = Bened.getBlockchain().getBlock(Convert.parseUnsignedLong(lastMilestoneBlockIdString));
                ...
                Logger.logWarningMessage("Old getMilestoneBlockIds request: "+peer.getHost()+" blacklisted:");
            ...
            blockId = Bened.getBlockchain().getBlockIdAtHeight(height);
