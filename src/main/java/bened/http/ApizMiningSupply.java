...
public final class ApizMiningSupply extends HttpServlet {
   ...
   private static String _znachenie = "no result";
    private void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(_height!=_bhg){
            _height=_bhg;
            _znachenie = ""+ new DecimalFormat("#0.000000").format((((Bened.softMG()._getGenesEm()*(-1D))-bened.Constants.START_BALANCE_centesimo)/1000000));      
        }
        ...
        try{
           json.put("MiningSupply", _znachenie);
