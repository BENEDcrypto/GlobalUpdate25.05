...
public final class DbShellServlet extends HttpServlet {
    ...
    private static final String errorNoPasswordIsConfigured =
            "This page is password-protected, but no password is configured in bened.properties. " +
                    "Please set bened.adminPassword or disable the password protection with bened.disableAdminPassword";
